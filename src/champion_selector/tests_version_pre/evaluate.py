...
if __name__ == "__main__":
    ...
    evaluate_and_log(favs, recs_challenger, 
                     alias = "challenger", 
                     model_version = ver_chall, 
                     run_id = run_id_chall, 
                     output_path = "metrics/challenger.json")
    evaluate_and_log(favs, recs_champion, 
                     alias = "champion", 
                     model_version = ver_champ, 
                     output_path = "metrics/champion.json")
